...
export default function Experience() {
  ...
  return (
    <section id="experience" className="py-20 xl:py-24">
      <div className="site-shell">
        ...
        >
          <SectionHeader
            title="Experience"
            description="I’ve learned the most from production systems, where small details matter, reliability becomes real, and good engineering means making things easier for the people around you."
          />
        </motion.div>

        <div className="grid gap-6 xl:grid-cols-[minmax(0,1.4fr)_minmax(360px,0.8fr)] xl:items-start">
          <div className="space-y-6">
            <motion.article
              ...
              className="cyber-border panel-sheen rainbow-glow rounded-3xl bg-card-bg px-8 py-8 transition-all duration-300 hover:glow-effect md:px-10 md:py-10 xl:px-12"
            >
              <div className="grid gap-8 lg:grid-cols-[minmax(300px,0.72fr)_minmax(0,1.28fr)] lg:gap-12">
                <div className="flex items-start gap-5">
                  <div className="h-16 w-16 flex-shrink-0 overflow-hidden rounded-lg bg-black/80 md:h-20 md:w-20">
                    <Image
                      src={featuredExperience.logo}
                ...
                <div className="max-w-4xl">
                  ...
                  {featuredExperience.impact ? (
                    <div className="mt-6">
                      <p className="mb-3 text-sm font-medium text-white/68">Impact</p>
          ...
          <div className="space-y-4 xl:pt-2">
            <p className="text-sm font-medium text-white/65">Other Highlights</p>
            <div className="grid gap-6">
              {additionalItems.map((item) => (
                <motion.article
                  ...
                  transition={{ duration: 0.3, ease: 'easeOut' }}
                  viewport={{ once: true, amount: 0.1 }}
                  className="cyber-border panel-sheen rainbow-glow rounded-3xl bg-card-bg px-6 py-6 transition-all duration-300 hover:glow-effect md:px-7"
                >
                  <div className="flex items-start gap-4">
                    {item.logo ? (
                      <div className="h-14 w-14 flex-shrink-0 overflow-hidden rounded-lg bg-black/80">
